...
export async function salvarVistoria(vistoriaId, userId, patch) {
  const payload = {
    ...
    bairro: patch.bairro || null,
    cep: patch.cep || null,
    uf: patch.uf || null,
    area_m2: patch.areaM2 || null,
    total_comodos: patch.totalComodos || null,
    nome_locador: patch.nomeLocador || null,
    nome_responsavel_entrega: patch.nomeResponsavelEntrega || null,
